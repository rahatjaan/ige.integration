...
public class GuestSignatureTransformer {
	public static String transform(String message,boolean flag) throws ParserConfigurationException, SAXException, IOException{
		if(flag){
			...
			message = "<GuestSignatureRS><ServiceError>"+message+"</ServiceError></GuestSignatureRS>";
			...
			message = message.substring(ind1);
			message = "<GuestSignatureRS>"+message+"</GuestSignatureRS>";
			System.out.println("Message is: "+message);
		}
		return message;
	}
