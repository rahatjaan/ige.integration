...
public class AuditLogs implements java.io.Serializable {
    ...
    public AuditLogs(String createdBy, String createdDate, String actionDescription, String actionResult, String userName, String tenantId, String requestPayload, String responsePayload) {
